...
<html>
    ...
    <body>
        ...
        //miro la variable de sesion cerrar sesion
        $cerrarsesion = $_SESSION['cerrarsesion'];

        //si la variable de sesion cerrarsesion no esta vacia es que no he cerrado sesion
                ...
                if ($conexion->siguiente()) {
                    ...
                    if ($password === $passworddescodificada) {
                        ...
                        <form action="index.php" method="POST">
                            <input type="submit" name="cerrarsesion" value="Cerrar sesion" class="btn btn-primary">
                        </form>
                        <?php
                    }
            ...
            //si vengo de Registro.php
                ...
                //si no devuelve datos el cursor
                    ...
                    if ($conexion->insertar_usuario("usuario", $_REQUEST['nombre'], $_REQUEST['apellidos'], $_REQUEST['fechanacimiento'], $_REQUEST['email'], $_REQUEST['tlf'], $passwordcifrada)) {
                        ...
                        <label>Bienvenido <?php echo $_REQUEST["email"] ?></label>
                        <form action="index.php" method="POST">
                            <input type="submit" name="cerrarsesion" value="Cerrar sesion" class="btn btn-primary">
                        </form>
                        <?php
