    ...
    <body>
        ...
        <div class="divregistro">
            <form action="Bienvenido.php" method="POST">
                ...
                <input type="number" name="tlf" required class="form-control inputsregistro" placeholder="Tlf">
                ...
                <input type="submit" name="registrar" id="registrar" value="Registrar" class="btn btn-primary buttonregistro"><br><br>
